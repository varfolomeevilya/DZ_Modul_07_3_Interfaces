...
public class CompactMachine extends CoffeeMachine {
    ...
    public CompactMachine(int waterTankVolume, int coffeeTankVolume, int usedCoffeeTankVolume, int milkTankVolume) {
