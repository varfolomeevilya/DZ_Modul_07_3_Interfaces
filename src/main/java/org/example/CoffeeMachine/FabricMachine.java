...
public class FabricMachine extends CoffeeMachine {
    ...
    public FabricMachine(int waterTankVolume, int coffeeTankVolume, int usedCoffeeTankVolume, int milkTankVolume, int grainCoffeeTankVolume) {
